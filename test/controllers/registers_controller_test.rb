...
class RegistersControllerTest < ActionController::TestCase
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post :create, register: { college_name: @register.college_name, dept_name: @register.dept_name, mob_no: @register.mob_no, name: @register.name, register_no: @register.register_no }
    end
  ...
  test "should update register" do
    patch :update, id: @register, register: { college_name: @register.college_name, dept_name: @register.dept_name, mob_no: @register.mob_no, name: @register.name, register_no: @register.register_no }
    assert_redirected_to register_path(assigns(:register))
  end
